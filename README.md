...
The CounterFact certificate is at revision 5; revisions 1 to 4 are superseded and their signatures are void — all are kept under `superseded/` for the record.
